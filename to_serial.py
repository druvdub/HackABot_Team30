...
from movement import go_to_point, stop_at_boundary, check_if_ball_is_near
...
def fetch_data():
	...
	if chech_for_goal_sides:
		# It means that the bot is on the right side
		if (g42[0] + g43[0])//2 <= c0[0]:
			our_goal = g43
		else:
			our_goal = g42

		chech_for_goal_sides = False 
